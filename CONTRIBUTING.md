...
6. Work your magic
7. `npm run lint` and `npm test` to make sure nothing is broken
8. `npm run build` to kick off a production build
9. To test service worker changes (production only):
  * `npm run build`
