...
This app uses [`vite-plugin-pwa`](https://vite-pwa-org.netlify.app/) (which wraps [Workbox](https://workboxjs.org/)) to generate a service worker as part of the build step so the app loads quickly and works offline.
...
This project is built with [Vite](https://vitejs.dev/), React and TypeScript.
 ...
 - `npm install`
 - `npm run dev` to run the application with Vite's dev server
