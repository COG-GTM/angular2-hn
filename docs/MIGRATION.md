...
| 2 | shared/error-message | `src/app/shared/components/error-message/*` | `react/src/components/ErrorMessage` | 0 | ported | [#816](https://github.com/COG-GTM/angular2-hn/pull/816) |
