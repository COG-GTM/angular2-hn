...
<p align="center">
  A progressive Hacker News client built with React and Vite
</p>
...
This app uses [vite-plugin-pwa](https://vite-pwa-org.netlify.app/) (with [Workbox](https://workboxjs.org/)) to generate a service worker as part of the build step to load quickly and work offline.
...
This project uses React 18, TypeScript, Vite, and React Router.

 - Clone or download the repo
 - `npm install`
 - `npm run dev` to start the Vite development server at http://localhost:5173
 - `npm run build` to create a production build in `dist/`
 - `npm run preview` to serve the production build and test the generated service worker
