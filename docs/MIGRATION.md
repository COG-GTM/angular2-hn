...
| 3 | core/footer | `src/app/core/footer/*` | `react/src/components/Footer` | 0 | ported | [#815](https://github.com/COG-GTM/angular2-hn/pull/815) |
...
| Wave 1 — core/footer | 5 | ~45 | SCSS sourced from the Angular `shared/scss` partials (no duplicated theme vars), `#footer` id/class parity, footer mounted in the placeholder `AppShell` |
