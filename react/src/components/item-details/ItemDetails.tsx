...
/** The Angular component reported a single message for any fetch failure. */
...
export function ItemDetails() {
    ...
    const { data: item, loading, error } = useItem(Number(id));
    ...
    return (
        <div className="main-content">
            {!item && loading && <Loader />}
            {!item && !loading && error !== null && <ErrorMessage message={ERROR_MESSAGE} />}
