...
6. Work your magic
7. Run `npm run build` to type-check and kick off a production build and make sure nothing is broken
8. To test service worker changes:
  * `npm run build` to kick off a fresh build and generate the service worker in `dist/`
