...
- Persist user state with `localStorage`, following the pattern in `SettingsService` (`src/app/shared/services/settings.service.ts`) — don't add a state-management library
